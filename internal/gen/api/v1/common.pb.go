...
var file_api_v1_common_proto_rawDesc = []byte{
	...
	0x52, 0x12, 0x6c, 0x61, 0x73, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e,
	0x54, 0x69, 0x6d, 0x65, 0x2a, 0xf7, 0x07, 0x0a, 0x0d, 0x4b, 0x38, 0x73, 0x4f, 0x62, 0x6a, 0x65,
...
var file_api_v1_common_proto_msgTypes = make([]protoimpl.MessageInfo, 152)
var file_api_v1_common_proto_goTypes = []interface{}{
	...
	nil,                                  // 118: api.v1.WorkloadItem.LabelsEntry
	nil,                                  // 119: api.v1.WorkloadItem.AnnotationsEntry
	nil,                                  // 120: api.v1.Node.LabelsEntry
	nil,                                  // 121: api.v1.Node.AnnotationsEntry
	(*LabelSelector_Label)(nil),          // 122: api.v1.LabelSelector.Label
	nil,                                  // 123: api.v1.LabelSelector.MatchLabelsEntry
	nil,                                  // 124: api.v1.ResourceDetails.ServiceSelectorEntry
	nil,                                  // 125: api.v1.ResourceDetails.ScParametersEntry
	nil,                                  // 126: api.v1.ServiceDetails.SelectorEntry
	nil,                                  // 127: api.v1.ResourceRequirements.RequestsEntry
	nil,                                  // 128: api.v1.ResourceRequirements.LimitsEntry
	nil,                                  // 129: api.v1.PersistentVolumeDetails.CapacityEntry
	nil,                                  // 130: api.v1.PVVolumeSource.VolumeAttributesEntry
	nil,                                  // 131: api.v1.CSIVolumeSource.VolumeAttributesEntry
	nil,                                  // 132: api.v1.StorageClassDetails.ParametersEntry
	nil,                                  // 133: api.v1.NamespaceDetails.ConditionsEntry
	nil,                                  // 134: api.v1.NodeDetails.CapacityEntry
	nil,                                  // 135: api.v1.NodeDetails.AllocatableEntry
	nil,                                  // 136: api.v1.TopologySelectorTerm.MatchLabelsEntry
	nil,                                  // 137: api.v1.HPAMetricSelector.SelectorEntry
	nil,                                  // 138: api.v1.VPAContainerResourcePolicy.MinAllowedEntry
	nil,                                  // 139: api.v1.VPAContainerResourcePolicy.MaxAllowedEntry
	nil,                                  // 140: api.v1.VPAContainerRecommendation.TargetEntry
	nil,                                  // 141: api.v1.VPAContainerRecommendation.LowerBoundEntry
	nil,                                  // 142: api.v1.VPAContainerRecommendation.UpperBoundEntry
	nil,                                  // 143: api.v1.VPAContainerRecommendation.UncappedTargetEntry
	nil,                                  // 144: api.v1.LimitRangeItem.DefaultLimitsEntry
	nil,                                  // 145: api.v1.LimitRangeItem.DefaultRequestEntry
	nil,                                  // 146: api.v1.LimitRangeItem.MaxEntry
	nil,                                  // 147: api.v1.LimitRangeItem.MinEntry
	nil,                                  // 148: api.v1.LimitRangeItem.MaxLimitRequestRatioEntry
	nil,                                  // 149: api.v1.KedaScaledObjectTrigger.MetadataEntry
	nil,                                  // 150: api.v1.KarpenterResourceDetails.LimitsEntry
	nil,                                  // 151: api.v1.KarpenterCapacity.OtherEntry
	nil,                                  // 152: api.v1.PodDisruptionBudgetDetails.SelectorLabelsEntry
	nil,                                  // 153: api.v1.ResourceQuotaDetails.HardLimitsEntry
	nil,                                  // 154: api.v1.ResourceQuotaDetails.UsedEntry
	nil,                                  // 155: api.v1.ResourceQuotaDetails.ScopeSelectorEntry
	(*timestamppb.Timestamp)(nil),        // 156: google.protobuf.Timestamp
	(*money.Money)(nil),                  // 157: google.type.Money
}
var file_api_v1_common_proto_depIdxs = []int32{
	0,   // 0: api.v1.AuditLogEntry.workload_type:type_name -> api.v1.K8sObjectKind
	156, // 1: api.v1.AuditLogEntry.created_at:type_name -> google.protobuf.Timestamp
	156, // 2: api.v1.AuditLogEntry.updated_at:type_name -> google.protobuf.Timestamp
	1,   // 3: api.v1.Pagination.order_by:type_name -> api.v1.OrderByEnum
	157, // 4: api.v1.CostInfo.node_recommendation_saved_cost_last_month:type_name -> google.type.Money
	156, // 5: api.v1.ForecastResourceMetrics.timestamp:type_name -> google.protobuf.Timestamp
	10,  // 6: api.v1.WorkloadItem.children:type_name -> api.v1.WorkloadItem
	118, // 7: api.v1.WorkloadItem.labels:type_name -> api.v1.WorkloadItem.LabelsEntry
	119, // 8: api.v1.WorkloadItem.annotations:type_name -> api.v1.WorkloadItem.AnnotationsEntry
	...
	156, // 13: api.v1.WorkloadItem.created_at:type_name -> google.protobuf.Timestamp
	156, // 14: api.v1.WorkloadItem.deleted_at:type_name -> google.protobuf.Timestamp
	...
	120, // 21: api.v1.Node.labels:type_name -> api.v1.Node.LabelsEntry
	121, // 22: api.v1.Node.annotations:type_name -> api.v1.Node.AnnotationsEntry
	15,  // 23: api.v1.Node.volumes_attached:type_name -> api.v1.AttachedVolume
	156, // 24: api.v1.Node.last_seen:type_name -> google.protobuf.Timestamp
	156, // 25: api.v1.Node.collected_at:type_name -> google.protobuf.Timestamp
	156, // 26: api.v1.Node.deletion_timestamp:type_name -> google.protobuf.Timestamp
	...
	122, // 39: api.v1.LabelSelector.labels:type_name -> api.v1.LabelSelector.Label
	123, // 40: api.v1.LabelSelector.match_labels:type_name -> api.v1.LabelSelector.MatchLabelsEntry
	...
	124, // 67: api.v1.ResourceDetails.service_selector:type_name -> api.v1.ResourceDetails.ServiceSelectorEntry
	125, // 68: api.v1.ResourceDetails.sc_parameters:type_name -> api.v1.ResourceDetails.ScParametersEntry
	...
	126, // 88: api.v1.ServiceDetails.selector:type_name -> api.v1.ServiceDetails.SelectorEntry
	...
	127, // 100: api.v1.ResourceRequirements.requests:type_name -> api.v1.ResourceRequirements.RequestsEntry
	128, // 101: api.v1.ResourceRequirements.limits:type_name -> api.v1.ResourceRequirements.LimitsEntry
	...
	129, // 104: api.v1.PersistentVolumeDetails.capacity:type_name -> api.v1.PersistentVolumeDetails.CapacityEntry
	...
	130, // 111: api.v1.PVVolumeSource.volume_attributes:type_name -> api.v1.PVVolumeSource.VolumeAttributesEntry
	131, // 112: api.v1.CSIVolumeSource.volume_attributes:type_name -> api.v1.CSIVolumeSource.VolumeAttributesEntry
	132, // 113: api.v1.StorageClassDetails.parameters:type_name -> api.v1.StorageClassDetails.ParametersEntry
	66,  // 114: api.v1.StorageClassDetails.allowed_topologies:type_name -> api.v1.TopologySelector
	133, // 115: api.v1.NamespaceDetails.conditions:type_name -> api.v1.NamespaceDetails.ConditionsEntry
	...
	134, // 119: api.v1.NodeDetails.capacity:type_name -> api.v1.NodeDetails.CapacityEntry
	135, // 120: api.v1.NodeDetails.allocatable:type_name -> api.v1.NodeDetails.AllocatableEntry
	...
	136, // 123: api.v1.TopologySelectorTerm.match_labels:type_name -> api.v1.TopologySelectorTerm.MatchLabelsEntry
	...
	137, // 140: api.v1.HPAMetricSelector.selector:type_name -> api.v1.HPAMetricSelector.SelectorEntry
	...
	138, // 158: api.v1.VPAContainerResourcePolicy.min_allowed:type_name -> api.v1.VPAContainerResourcePolicy.MinAllowedEntry
	139, // 159: api.v1.VPAContainerResourcePolicy.max_allowed:type_name -> api.v1.VPAContainerResourcePolicy.MaxAllowedEntry
	96,  // 160: api.v1.VPARecommendation.container_recommendations:type_name -> api.v1.VPAContainerRecommendation
	140, // 161: api.v1.VPAContainerRecommendation.target:type_name -> api.v1.VPAContainerRecommendation.TargetEntry
	141, // 162: api.v1.VPAContainerRecommendation.lower_bound:type_name -> api.v1.VPAContainerRecommendation.LowerBoundEntry
	142, // 163: api.v1.VPAContainerRecommendation.upper_bound:type_name -> api.v1.VPAContainerRecommendation.UpperBoundEntry
	143, // 164: api.v1.VPAContainerRecommendation.uncapped_target:type_name -> api.v1.VPAContainerRecommendation.UncappedTargetEntry
	99,  // 165: api.v1.LimitRangeDetails.limits:type_name -> api.v1.LimitRangeItem
	144, // 166: api.v1.LimitRangeItem.default_limits:type_name -> api.v1.LimitRangeItem.DefaultLimitsEntry
	145, // 167: api.v1.LimitRangeItem.default_request:type_name -> api.v1.LimitRangeItem.DefaultRequestEntry
	146, // 168: api.v1.LimitRangeItem.max:type_name -> api.v1.LimitRangeItem.MaxEntry
	147, // 169: api.v1.LimitRangeItem.min:type_name -> api.v1.LimitRangeItem.MinEntry
	148, // 170: api.v1.LimitRangeItem.max_limit_request_ratio:type_name -> api.v1.LimitRangeItem.MaxLimitRequestRatioEntry
	...
	149, // 176: api.v1.KedaScaledObjectTrigger.metadata:type_name -> api.v1.KedaScaledObjectTrigger.MetadataEntry
	...
	150, // 180: api.v1.KarpenterResourceDetails.limits:type_name -> api.v1.KarpenterResourceDetails.LimitsEntry
	151, // 181: api.v1.KarpenterCapacity.other:type_name -> api.v1.KarpenterCapacity.OtherEntry
	...
	152, // 188: api.v1.PodDisruptionBudgetDetails.selector_labels:type_name -> api.v1.PodDisruptionBudgetDetails.SelectorLabelsEntry
	115, // 189: api.v1.PodDisruptionBudgetDetails.conditions:type_name -> api.v1.PodDisruptionBudgetCondition
	153, // 190: api.v1.ResourceQuotaDetails.hard_limits:type_name -> api.v1.ResourceQuotaDetails.HardLimitsEntry
	154, // 191: api.v1.ResourceQuotaDetails.used:type_name -> api.v1.ResourceQuotaDetails.UsedEntry
	155, // 192: api.v1.ResourceQuotaDetails.scope_selector:type_name -> api.v1.ResourceQuotaDetails.ScopeSelectorEntry
